...
class Multiscanner:
    ...
    def __init__(self, dork_file, output, threads):
        ...
        self.engines = {
            ...
            Multiscanner.ENGINE_YAHOO: {
                'progress_string': '[***Yahoo***] Quering page {}/{} with dork {}\n',
                'search_string': 'https://search.yahoo.com/search?p={}&page={}',
                'page_range': xrange(1, self.ptr_limits['yahoo'])
            },
